...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d005e939-6452-4d92-b882-f25b84b0c41c
```

> `d005e939-6452-4d92-b882-f25b84b0c41c` is the password of the certificate, you can change it to any password you want.
